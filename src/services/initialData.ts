import type { SchoolSubject, Exam, Weakness, NationalExamPaper } from '../types/school';
...
import { OFFICIAL_BAC_EXAMS, OFFICIAL_BAC_WEAKNESSES, OFFICIAL_NATIONAL_PAPERS, LESSON_EXTRA_DATA } from './bacData';
import { OFFICIAL_GERMAN_VOCAB } from './germanVocabData';
...
// Enrich chapters & lessons with official Moroccan National Exam metadata
INITIAL_SUBJECTS.forEach(subject => {
  subject.chapters.forEach(chapter => {
    chapter.lessons.forEach(lesson => {
      const extra = LESSON_EXTRA_DATA[lesson.id];
      if (extra) {
        lesson.nationalWeight = extra.weight;
        lesson.keyFormula = extra.formula;
        lesson.examTip = extra.tip;
        lesson.alloschoolUrl = extra.url;
      }
    });
  });
});

export const INITIAL_EXAMS: Exam[] = OFFICIAL_BAC_EXAMS;

export const INITIAL_WEAKNESSES: Weakness[] = OFFICIAL_BAC_WEAKNESSES;

export const INITIAL_NATIONAL_PAPERS: NationalExamPaper[] = OFFICIAL_NATIONAL_PAPERS;

export const INITIAL_GERMAN_VOCAB: VocabCard[] = OFFICIAL_GERMAN_VOCAB;
...
export const INITIAL_AUSBILDUNG_MILESTONES: AusbildungMilestone[] = [
  { id: 'ab-m1', order: 1, title: 'Deutsch A1/A2 Zertifizierung', description: 'Grundlagen der deutschen Sprache abschließen', category: 'language', targetDate: '2026-11-30', completed: false, createdAt: '2026-09-01T00:00:00Z', updatedAt: '2026-09-01T00:00:00Z' },
  { id: 'ab-m2', order: 2, title: 'Deutsch B1 Zertifikat (Goethe / telc)', description: 'Mittelstufe B1 mit Prädikat bestehen', category: 'language', targetDate: '2027-02-28', completed: false, createdAt: '2026-09-01T00:00:00Z', updatedAt: '2026-09-01T00:00:00Z' },
  { id: 'ab-m3', order: 3, title: 'Deutsch B2 Vorbereitung', description: 'Fachsprache Informatik & berufsbezogenes Deutsch', category: 'language', targetDate: '2027-05-30', completed: false, createdAt: '2026-09-01T00:00:00Z', updatedAt: '2026-09-01T00:00:00Z' },
  { id: 'ab-m4', order: 4, title: 'Baccalauréat 2027 mit Auszeichnung (Mention Très Bien)', description: 'Examen National mit hoher Note abschließen', category: 'documents', targetDate: '2027-06-25', completed: false, createdAt: '2026-09-01T00:00:00Z', updatedAt: '2026-09-01T00:00:00Z' },
  { id: 'ab-m5', order: 5, title: 'Bewerbungsdossier (Tabellarischer Lebenslauf & Anschreiben)', description: 'Unterlagen nach deutschem Standard fertigstellen', category: 'documents', targetDate: '2027-07-15', completed: false, createdAt: '2026-09-01T00:00:00Z', updatedAt: '2026-09-01T00:00:00Z' },
  { id: 'ab-m6', order: 6, title: 'Bewerbungen & Vorstellungsgespräche bei Ausbildungsbetrieben', description: 'Interviews für Fachinformatiker Anwendungsentwicklung', category: 'applications', targetDate: '2027-08-15', completed: false, createdAt: '2026-09-01T00:00:00Z', updatedAt: '2026-09-01T00:00:00Z' },
  { id: 'ab-m7', order: 7, title: 'Ausbildungsvertrag & Visum (§16a AufenthG)', description: 'Vertragsunterschrift, Visumsantrag & Einreise nach Deutschland', category: 'visa', targetDate: '2027-09-15', completed: false, createdAt: '2026-09-01T00:00:00Z', updatedAt: '2026-09-01T00:00:00Z' },
];
...
export const INITIAL_HABITS: Habit[] = [
  {
    id: 'hab-1',
    name: 'Morning Bac Math or Physics Deep Work',
    category: 'study',
    routineTime: 'morning',
    targetPerWeek: 7,
    currentStreak: 0,
  ...
  {
    id: 'hab-2',
    name: 'German Wortschatz & Grammatik',
    category: 'german',
    routineTime: 'deep_work',
    targetPerWeek: 6,
    currentStreak: 0,
    longestStreak: 0,
    completedDates: [],
  ...
  {
    id: 'hab-3',
    name: 'Software Dev / Coding Practice',
    category: 'code',
    routineTime: 'evening',
    targetPerWeek: 5,
    currentStreak: 0,
...
export const INITIAL_GOALS: LifeGoal[] = [
  {
    ...
    domain: 'academic',
    description: 'Score >= 16/20 on the National Exam with focus on Math (Coef 7) and PC (Coef 7)',
    targetDate: '2027-06-30',
    priority: 'p1',
    completed: false,
    milestones: [
      { id: 'gm-1', goalId: 'goal-1', title: 'Master Semestre 1 National syllabus (Math, PC, SVT)', completed: false },
      { id: 'gm-2', goalId: 'goal-1', title: 'Achieve >= 17.5 in all Term 1 Devoirs Surveillés', completed: false },
      { id: 'gm-3', goalId: 'goal-1', title: 'Complete all Past National Exam papers 2018-2026', completed: false },
    ],
    createdAt: '2026-09-01T00:00:00Z',
    updatedAt: '2026-09-01T00:00:00Z'
  },
  {
    ...
    domain: 'german',
    description: 'B2 German certification and fullstack portfolio projects to secure an IT apprenticeship contract in Germany',
    targetDate: '2027-09-01',
    priority: 'p1',
    completed: false,
    milestones: [
      { id: 'gm-4', goalId: 'goal-2', title: 'Achieve Goethe/telc B2 Certificate', completed: false },
      { id: 'gm-5', goalId: 'goal-2', title: 'Build 3 fullstack portfolio projects to impress German companies', completed: false },
      { id: 'gm-6', goalId: 'goal-2', title: 'Pass technical interview in German and sign contract', completed: false }
    ],
    createdAt: '2026-09-01T00:00:00Z',
    updatedAt: '2026-09-01T00:00:00Z'
  }
